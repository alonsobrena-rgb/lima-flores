...
**Sin el nombre**, que hoy es la plantilla gemela `box_simona_sin_nombre`: un
cuerpo sin variable, aprobado aparte, que el envío le manda a quien no tiene
nombre guardado. Ver «El contacto sin nombre» en
`integrations/whatsapp/README.md`. Esta fue la primera versión escrita a mano:
