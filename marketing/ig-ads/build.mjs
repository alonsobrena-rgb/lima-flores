...
function writeDeck({ campaign, products, ads }) {
  ...
  L.push('| --- | --- | --- |');
  L.push('| «Eliges el día y la hora» · «Pídelo hoy, llega mañana» | `site/js/checkout.js` | `LEAD_MS = 24h`; el cliente elige fecha y slot de 30 min entre 8:00 y 20:30, con ventana de ±30 min |');
  ...
  L.push('');
  L.push('El **«8 a 12 semanas»** de IG-04. La cifra está publicada en la landing, pero referida a las');
  ...
  L.push('- **«Un ramo dura 8 días»** (IG-04) y **«los tulipanes duran una semana»** (IG-02). Cifras mías.');
