...
import { adminGet, AuthError } from '@/lib/admin-api';
      ...
      {!loading && !err && (
        <div className="overflow-x-auto border border-border">
          <table className="w-full min-w-[820px] text-left text-[13px]">
            ...
            <tbody>
              {!subs.length && <tr><td colSpan={7} className="px-3 py-12 text-center italic text-foreground/40">Aún no hay suscripciones.</td></tr>}
              {subs.map((s) => (
